...
from app.schemas import AskRequest, AskResponse, Citation, PredictionSignal, SignalRouting, TriageLevel
from signals.route_query import route_query
...
def _build_response(req: AskRequest, pipeline: QueryPipeline) -> AskResponse:
    ...
    signal_routing = route_query(clean_query, rule_tier=rule_tier, red_flags=red_flags)
